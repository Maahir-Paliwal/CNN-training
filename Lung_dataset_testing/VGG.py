...
myVGG19 = VGG19(input_shape=IMAGE_SIZE + [3], weights = 'imagenet', include_top=False)


for layer in myVGG19.layers:
...
model.save('/Users/maahirpaliwal/Downloads/lung_alrumeh_assem_train/output/myVGGLung.h5')
